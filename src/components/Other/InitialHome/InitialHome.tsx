...
const InitialHome = () => {
  ...
  const codeText = useMemo(() => {
    ...
    return `<span style="color:#6A9955">// Front-end developer with diverse skills</span>
<span style="color:#569CD6">const</span> developer = {
  <span style="color:#9CDCFE">name</span>: <span style="color:#CE9178">'Bahar Alekberova'</span>,
        ...
        >
          ...
          >
            ...
            >
              ...
              development with a deep passion for crafting intuitive,
              responsive, and high-performance web interfaces. My expertise is
              centered around{" "}
              <span className="text-primary font-semibold">React</span> and
              modern UI development, allowing me to build clean, maintainable,
              and scalable applications. I constantly challenge myself to learn
              new technologies and improve workflows to deliver robust and
            ...
            >
              ...
              <Link
                target="_blank"
                href="https://drive.google.com/file/d/1i9JZ4T9tgAZbUhjbuu_Ultf6Ea-VNfrn/view?usp=sharing"
                aria-label="cv"
              >
            ...
            <motion.div variants={fadeInRight} className="hidden md:block mb-8">
              ...
              <div className="flex flex-wrap gap-x-3 gap-y-2 transition-all duration-500 ease-in-out">
                {techStackData
                  .filter(
                    (tech, index) =>
                      tech.featured || techStackExpanded || index < 5
                  )
                  .map((tech, index) => (
                    <span
                      key={`${tech.name}-${index}`}
                ...
                {!techStackExpanded && techStackData.length > 5 && (
                  <button
                  ...
                  >
                    <span>+{techStackData.length - 5}</span>
          ...
          <motion.div variants={fadeInLeft} className="hidden xl:flex relative">
            ...
            {/* Code block */}
            <div className="absolute -left-20 bottom-[-250px] mb-28 z-30 ">
