...
const Work = () => {
  ...
  return (
    <section className="relative pt-[50px] xl:pt-[150px] -mt-[150px] mb-10">
      ...
      >
        ...
        >
          ...
          <div className="mb-8 w-full">
            <motion.div
              variants={fadeInUp}
              className="flex items-center py-4 p-3 rounded-lg border border-white/10 bg-white/5 backdrop-blur-sm"
            >
