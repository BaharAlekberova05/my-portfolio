...
const Seo = ({ title, description }: SeoInterface) => {
  return (
    <Head>
      <meta name="author" content="Bahar Alekberova" />
      <meta name="keywords" content="Javascript" />
      <link rel="fluid-icon" href="/ts.png" title="Bahar Alekberova" />
